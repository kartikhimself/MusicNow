...
import com.ksharkapps.musicnow.ui.MusicHolder;
...
public class ProfileSongAdapter extends ArrayAdapter<Song> {
     ...
     */
    public ProfileSongAdapter(final Activity context, final int layoutId, final int setting) {
        super(context, 0);
     ...
     * @param layoutId The resource Id of the view to inflate.
     */
    public ProfileSongAdapter(final Activity context, final int layoutId) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        switch (mDisplaySetting) {
            ...
            case DISPLAY_ALBUM_SETTING:
                ...
                // Set the artist image for song ( image)
                mImageFetcher.loadArtistImage(song.mArtistName, holder.mImage.get());
                break;
