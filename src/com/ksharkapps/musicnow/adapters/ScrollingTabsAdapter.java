...
import static com.ksharkapps.musicnow.Constants.TABS_ENABLED;
...
public class ScrollingTabsAdapter implements TabAdapter {
    ...
    public View getView(int position) {
        ...
        final String[] mTitles = activity.getResources().getStringArray(R.array.page_titles);
   ...
   /*     //Get tab visibility preferences
        ...
        if(tabs_set.size()==0)*/
        Set<String> defaults = new HashSet<String>(Arrays.asList(mTitles));
        Set<String> tabs_set = new HashSet<String>();
