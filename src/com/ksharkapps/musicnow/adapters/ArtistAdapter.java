...
import com.ksharkapps.musicnow.ui.MusicHolder.DataHolder;
...
public class ArtistAdapter extends ArrayAdapter<Artist> {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        //set colored description layout
        holder.mColoredDescription.get().setBackgroundColor(Color.parseColor(Utils.generateRandomColor(Math.abs(position))));
