...
package com.ksharkapps.musicnow.ui.fragments;
...
import com.ksharkapps.musicnow.adapters.SongAdapter;
import com.ksharkapps.musicnow.loaders.SongLoader;
import com.ksharkapps.musicnow.menu.CreateNewPlaylist;
import com.ksharkapps.musicnow.menu.DeleteDialog;
import com.ksharkapps.musicnow.menu.FragmentMenuItems;
import com.ksharkapps.musicnow.model.Song;
import com.ksharkapps.musicnow.provider.FavoritesStore;
import com.ksharkapps.musicnow.recycler.RecycleHolder;
import com.ksharkapps.musicnow.ui.activities.BaseActivity;
...
public class SongFragment extends Fragment implements LoaderCallbacks<List<Song>>,
    ...
    private ScrollableTabView scrollTabs;
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        // Create the adpater
        mAdapter = new SongAdapter(getActivity(), R.layout.list_item_extended);
        scrollTabs = (ScrollableTabView)getActivity().findViewById(R.id.fragment_home_phone_pager_titles);
    }
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        /*
        shuffle_temp = inflater.inflate(R.layout.shuffle_all, null);
        
        if (shuffle_temp!= null){
        mListView.addHeaderView(shuffle_temp); 
        }
        
    	/*shuffle = (RelativeLayout)shuffle_temp.findViewById(R.id.shuffle_wrapper);
