...
public class ShakeMusicBarViewSingle extends View {
	...
	public ShakeMusicBarViewSingle(Context context, Handler handler) {
		super(context);
		mHandler = handler;
	...
	public ShakeMusicBarViewSingle(Context context){
