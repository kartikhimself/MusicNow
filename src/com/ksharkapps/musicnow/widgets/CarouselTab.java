...
import com.ksharkapps.musicnow.misc.ImageBlurrer;
import com.ksharkapps.musicnow.utils.ApolloUtils;
import com.ksharkapps.musicnow.utils.BitmapUtils;
...
public class CarouselTab extends FrameLayoutWithOverlay {
    ...
    protected void onFinishInflate() {
        ...
        mAlbumName = (TextView)findViewById(R.id.profile_tab_album_label);
        // Set the alpha layer
    ...
    public void blurPhoto(final Activity context, final String artist,
        ...
        Bitmap artistImage = mFetcher.getCachedArtwork(album, artist);
        ...
        final Bitmap blur = ImageBlurrer.blurImage(context,artistImage, 25f, 2f);
