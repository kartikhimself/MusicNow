...
package com.ksharkapps.musicnow.misc;
...
public class Utils {
	...
	public static final String[] colorlist = {"#ff009688","#ff607d8b","#ffe91e63","#ff673ab7","#ffff5722","#fff36c60","#ff3f51b5","#ff03a9f4"};

	
	public static final String[] n_colorlist ={"#ff009688","#ff607d8b","#ff673ab7","#fff36c60","#ff3f51b5"};
	...
	public static long getDirectorySize(File dir) {
		...
		if (dir.listFiles() != null && dir.listFiles().length > 0) {
			for (File eachFile : dir.listFiles()) {
				result += eachFile.isDirectory() && eachFile.canRead() ? getDirectorySize(eachFile)
						: eachFile.length();
			}
	...
	public static String generateRandomColor(int index) {
        
		 index = (int)index % colorlist.length;
		 return colorlist[index];
		
        
    }
	
	public static String generateRandomColorNew(int index) {
        
		 index = (int)index % n_colorlist.length;
		 return n_colorlist[index];
